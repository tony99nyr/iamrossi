...
async function testPeriod(
  ...
  // Pass Kelly and ATR multipliers from strategy config
  const result = await runBacktest(startDate, endDate, isSynthetic, config, strategy.kellyMultiplier, strategy.atrMultiplier);
