/**
 * Migration script to parse existing weight field data in Redis
 * and split it into separate fields: timeElapsed, weight, reps, sets
 * 
 * Run with: npx tsx src/scripts/migrate-redis-weight-data.ts
 */
